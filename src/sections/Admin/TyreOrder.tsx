...
import { ArrowLeft, CircleDot, ShoppingBag, Calendar, MoreVertical, Trash2 } from 'lucide-react';
        ...
        <div className="space-y-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16" onClick={() => setActiveDropdown(null)}>
            ...
            <div className="flex items-center gap-4">
                ...
                <Header
                    ...
                    description="Track walk-in customer purchases, quantities, pricing, and payment statuses."
                />
            </div>
            ...
            {loading ? (
                ...
                <div className="bg-white/60 backdrop-blur-xl border border-slate-200/60 rounded-3xl p-16 text-center space-y-4 shadow-2xs">
                    ...
                    <div className="space-y-1 max-w-sm mx-auto">
                        <h3 className="text-base font-semibold text-slate-900">No tyre orders recorded</h3>
                        <p className="text-slate-500 text-xs leading-relaxed">
                            Walk-in customer transactions and purchase records will appear here once logged.
                        </p>
                    </div>
                </div>
            ) : (
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-slate-100 bg-slate-50/50 text-[11px] font-semibold text-slate-400 uppercase tracking-wider">
                                    ...
                                    <th className="py-4 px-6">Tyre / Brand</th>
